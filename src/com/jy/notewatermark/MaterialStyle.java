...
final class MaterialStyle {
    ...
    MaterialStyle(Activity activity) {
        ...
        surface = role("surface", dynamic("neutral1", dark ? 900 : 10, color("#FFF8F0", "#17130B")));
        container = role("surface_container", dynamic("neutral1", dark ? 900 : 50, color("#F5EDDF", "#231F17")));
        high = role("surface_container_high", dynamic("neutral1", dark ? 800 : 100, color("#EEE5D7", "#2E2921")));
        ink = role("on_surface", dynamic("neutral1", dark ? 100 : 900, color("#201B13", "#EAE1D4")));
        muted = role("on_surface_variant", dynamic("neutral2", dark ? 200 : 700, color("#4E4639", "#D1C5B4")));
        outline = role("outline", dynamic("neutral2", dark ? 400 : 500, color("#807667", "#998F80")));
        primary = dynamic("accent1", dark ? 200 : 600, color("#775A0B", "#E9C16C"));
        onPrimary = dynamic("accent1", dark ? 800 : 0, color("#FFFFFF", "#402D00"));
        primaryContainer = dynamic("accent1", dark ? 700 : 100, color("#FFE1A0", "#5B4300"));
        onPrimaryContainer = dynamic("accent1", dark ? 100 : 900, color("#261900", "#FFE1A0"));
    }
